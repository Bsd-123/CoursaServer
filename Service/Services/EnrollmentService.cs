...
namespace Service.Services
{
    public class EnrollmentService : IServiceDouble<EnrollmentDto>
    {
        ...
        public EnrollmentDto AddItem(EnrollmentDto item)
        {
            return mapper.Map<Enrollment, EnrollmentDto>(repository.AddItem(mapper.Map<EnrollmentDto, Enrollment>(item)));
        }
        ...
        public void UpdateItem(int id1, int id2, EnrollmentDto item)
        {
